...
export const htmlBlendMode = (node: MinimalBlendMixin): string => {
 ...
 * example: invisible
 */
export const htmlVisibility = (node: SceneNodeMixin): string => {
 ...
 */
export const htmlRotation = (node: any): string[] => {
